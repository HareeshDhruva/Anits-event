...
const page = () => {
  return (
    <div>
      ...
      <div className="z-0">
          <Image src="bg.svg" alt="" className="opacity-[0.3] left-0 right-0 top-10 fixed z-0" width={1500} height={1200} />
      </div>
      ...
      <motion.div className="flex justify-center items-center my-12 z-10"
       initial={{scale:0}}
